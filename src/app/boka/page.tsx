        ...
        <div className={styles.hero}>
          ...
          <div className={styles.geoLeft}>
            <svg width="80" height="200" viewBox="0 0 80 200" fill="none">
              <line x1="40" y1="0" x2="40" y2="200" stroke="#C9A24B" strokeWidth="0.5" />
              <line x1="10" y1="40" x2="70" y2="40" stroke="#C9A24B" strokeWidth="0.5" />
              <line x1="10" y1="160" x2="70" y2="160" stroke="#C9A24B" strokeWidth="0.5" />
              <circle cx="40" cy="40" r="14" stroke="#C9A24B" strokeWidth="0.5" fill="none" />
              <circle cx="40" cy="100" r="24" stroke="#C9A24B" strokeWidth="0.5" strokeDasharray="3 5" fill="none" />
              <circle cx="40" cy="160" r="14" stroke="#C9A24B" strokeWidth="0.5" fill="none" />
              <circle cx="40" cy="100" r="3" fill="#C9A24B" opacity="0.5" />
            </svg>
          </div>
